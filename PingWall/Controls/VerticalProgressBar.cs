...
namespace PingWall.Controls
{
    internal class VerticalProgressBar : VerticalStackLayout
    {
        ...
        public static BindableProperty ProgressColorProperty = BindableProperty.Create(nameof(ProgressColor), typeof(Color), typeof(VerticalProgressBar), Colors.Transparent);
        public static BindableProperty RestColorProperty = BindableProperty.Create(nameof(RestColor), typeof(Color), typeof(VerticalProgressBar), Colors.Transparent);
